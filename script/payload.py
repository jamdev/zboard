...
# Default settings
settings = {
    "foregroundpalette": [[0,0,0],[255,0,0],[0,255,0],[0,0,255],[255,255,0],[255,0,255],[0,255,255],[255,255,255]],
...
messages = {
    ...
    "messages": {
        "0":{
            ...
            "backgroundargs": "red", #not validated; up to function to check
            "shadow": False, #must be a bool
            "pause": 0.0, #seconds, must be a float
        },
        "1":{
            "text": "error", #must be a str
            "effect": "scroll", #must be a str
            "speed": 0.1, # must be a float
            "loops": 1, # must be an int
            "foregroundcolour": 7, #must be an int
            "backgroundcolour": 0, #must be an int
        ...
        "2":{
            "text": "could not connect", #must be a str
            "effect": "scroll", #must be a str
            "speed": 0.1, # must be a float
            "loops": 1, # must be an int
            "foregroundcolour": 7, #must be an int
            "backgroundcolour": 0, #must be an int
            "backgroundtype": "plain", #must be an str
            "backgroundargs": "", #not validated; up to function to check
            "shadow": False, #must be a bool
            "pause": 0.0, #seconds, must be a float
        },
    ...
    "loops": 1 #number of loops before restarting board
}
